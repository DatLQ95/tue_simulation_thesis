...
class FlowSimulator:
    ...
    def depart_flow(self, flow):
        ...
        self.params.metrics.completed_flow_sfc(flow.sfc)
        self.params.metrics.add_end2end_delay(flow.end2end_delay)
        self.params.metrics.add_end2end_delay_sfc(flow.end2end_delay, flow.sfc)
        self.params.logger.info(
            "Flow {} of SFC {} was processed and departed the network from {}. Time {}"
            .format(flow.flow_id, flow.sfc, flow.current_node_id, self.env.now))
